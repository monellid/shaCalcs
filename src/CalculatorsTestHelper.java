...
public class CalculatorsTestHelper {
	...
	public static ScalarIntensityMeasureRelationshipAPI getTestIMR() {
	...
	public static double[] getTestIMRPeriods() {
		SA_Param sa = (SA_Param) CalculatorsTestHelper.getTestIMR()
	...
	public static GEMSourceData getTestSourceData() {
